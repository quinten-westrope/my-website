                                ...
                                <Grid container spacing={1} alignItems="center">
                                    ...
                                    >
                                        <Box sx={{
                                            ...
                                            <Typography variant="h4" marginBottom='2rem' utterBottom fontFamily={'Sans-serif'}>
                                                BudgetBro
                                            </Typography>
                                            ...
                                            <Typography sx={{ mt: 2, fontFamily:'lora-regular', fontSize:19 }}>
                                                <span style={{ fontWeight: 550}}>Technical Implemention</span>
                                            </Typography>
                                    ...
                                    >
                                        <Box sx={{
                                            ...
                                            <Typography sx={{ mt: 2, fontFamily:'lora-regular', marginTop: -.01, fontSize:19 }}>
                                            • <span style={{fontWeight: 550}}>Multithreading:</span> Implements threading to handle the timing mechanism, ensuring that the application remains responsive during typing tests
                                            </Typography>
                                            <Typography sx={{ mt: 2, fontFamily:'lora-regular', marginTop: -.01, fontSize:19}}>
                                            ...
                                            <Typography sx={{ mt: 2, fontFamily:'lora-regular', marginTop: -.01, fontSize:19}}>
                                            • <span style={{fontWeight: 550}}>Real-Time Typing Speed Measurement:</span> Calculates Words Per Minute (WPM) in real-time and updates the display dynamically as the user types
                                            </Typography>
